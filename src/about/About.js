              ...
              <div className="absolute w-1/2 top-0 left-0">
                <div className="relative pb-1/1 overflow-hidden">
                  <img
                    ...
                    alt="cats"
                    className="absolute w-full h-full object-cover"
                    style={{ clipPath: "polygon(0% 33.33%, 33.33% 0%, 100% 0%, 100% 100%, 0% 100%)" }}
                  />
                </div>
              </div>
              <div className="absolute w-1/2 top-0 right-0">
                <div className="relative pb-1/1 overflow-hidden">
                  <img
                    ...
                    alt="cats"
                    className="absolute w-full h-full object-cover"
                    style={{ clipPath: "polygon(66.66% 0%, 100% 33.33%, 100% 100%, 0% 100%, 0% 0%)" }}
                  />
                </div>
              </div>
              <div className="absolute w-1/2 bottom-0 left-0">
                <div className="relative pb-1/1 overflow-hidden">
                  <img
                    ...
                    alt="cats"
                    className="absolute w-full h-full object-cover"
                    style={{ clipPath: "polygon(33.33% 100%, 0% 66.66%, 0% 0%, 100% 0%, 100% 100%)" }}
                  />
                </div>
              </div>
              <div className="absolute w-1/2 bottom-0 right-0">
                <div className="relative pb-1/1 overflow-hidden">
                  <img
                    ...
                    alt="cats"
                    className="absolute w-full h-full object-cover"
                    style={{ clipPath: "polygon(100% 66.66%, 66.66% 100%, 0% 100%, 0% 0%, 100% 0%)" }}
                  />
                </div>
              </div>
            </div>
          ...
          <div className="w-full lg:w-1/2">
            <div className="relative pb-1/1 overflow-hidden">
              <img
                ...
                className="absolute w-full h-full object-cover"
              />
              <div className="absolute w-full bg-white" style={{ height: 50 }} />
              <div className="absolute w-full bottom-0 bg-white" style={{ height: 50 }} />
            </div>
          </div>
        </div>
        {/* --- Hobbies --- */}
